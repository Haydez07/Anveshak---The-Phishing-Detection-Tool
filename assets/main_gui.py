...
# Configure a simple module-level logger
...
app = ctk.CTk()
app.title("Anveshak - The Phishing Detection Tool")
...
title_label = ctk.CTkLabel(left_panel, text="Anveshak - The Phishing Detection Tool", font=("Arial", 18, "bold"))
    ...
    def process():
        ...
        try:
            ...
            map_file = details.get('map_file', None)
                ...
                # Fix for f-string backslash error: precompute redirect_chain_text
                if isinstance(redirect_chain, list):
                    redirect_chain_text = "\n".join(redirect_chain)
                else:
                    redirect_chain_text = str(redirect_chain)
